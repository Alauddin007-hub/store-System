                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <form action="{{ route('transactions.store') }}" method="POST" class="form-produk">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-5">
                                        <select name="customer_id" id="customer_id" class="form-control select2">
                                            <option disabled selected>কাস্টমার সিলেক্ট করুন...</option>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        <label for="">কাস্টমার নাম</label>
                                        <input type="text" name="customerName" value="{{old('customerName')}}" class="form-control" placeholder="কাস্টমারের নাম লিখুন">
                                    </div>
                                    <div class="col-lg-4">
                                        <label for="">ফোন নম্বর</label>
                                        <input type="text" name="phone" value="{{old('phoneNumber')}}" placeholder="ফোন নম্বর লিখুন" class="form-control">
                                    </div>
                                    <div class="col-lg-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-5">
                                        <select name="book_id" id="book_search" class="form-control select2">
                                            ...
                                            <option value="{{ $item->id }}" {{ old('book_id') == $item->id ? 'selected' : '' }} data-price="{{$item->price}}">{{ htmlspecialchars($item->book_bangla_name) }}</option>
                                            {{$item->book_bangla_name}}</option>
                                            @endif
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <label for="discountForAmount">Discount(TK.)</label>
                                                <input type="number" name="discountForAmount" class="form-control" id="discount-Amount" placeholder="Discount (TK.)" min="0" max="100" value="0">
                                                <hr>
                                                <label for="otherCost">Other Cost(TK.)</label>
                                                <input type="number" name="otherCost" class="form-control" id="otherCost" placeholder="Other Cost (TK.)" min="0" max="100" value="0">
                                                <hr>
    ...
    $(document).ready(function() {
        ...
        $('#book_search').on('change', function() {
            ...
            if (selectedBookId) {
                ...
                const query = encodeURIComponent(selectedBookName);
                if (query.length >= 2) {
                    fetch(`/siddikia/books/search?query=${query}`)
        ...
        function calculateTotal(subtotal) {
            ...
            const otherCost = parseFloat($('#otherCost').val()) || 0;

            // Apply percentage discount
            let total = subtotal * ((100 - discountPercentage) / 100);

            // Then subtract the flat discount amount
