                            ...
                            <form action="{{ route('transactions.store') }}" method="POST" class="form-produk">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" name="name" value="{{ old('name') }}" class="form-control" placeholder="Enter customer name">
                                    </div>
                                    <div class="col-lg-4">
                                ...
                                <div class="form-group row">
                                    <label for="book_search" class="col-lg-2">Test Search Book:</label>
                                    <div class="col-lg-5">
                                        <div class="input-group">
                                            <select class="form-control select2" id="book_search" name="book_id">
                                                <option value="" selected>Select or Search for a Book</option>
                                                @foreach ($books as $book)
                                                <option value="{{ $book->id }}" data-price="{{ $book->price }}">{{ $book->book_bangla_name }}</option>
                                                @endforeach
                                            </select>
...
<script>
    $(document).ready(function() {
        ...
        $('#book_search').on('change', function() {
            ...
            if (selectedBookId) {
                // selectProduct(selectedBookId, selectedBookName, selectedBookPrice);
        ...
        // Event delegation to handle dynamically added buttons in modal
