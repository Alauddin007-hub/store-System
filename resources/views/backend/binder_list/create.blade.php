            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        @endif
                        <!-- form start -->
                        <form method="post" action="{{ route('binder_list.store') }}" enctype="multipart/form-data">

                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="name">বাধাইখানার নাম</label>
                                    <input type="text" class="form-control" name="name" value="{{old('name')}}" placeholder="বাধাইখানার নাম লিখুন">
                                </div>
                                <div class="form-group">
