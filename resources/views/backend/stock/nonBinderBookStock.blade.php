...
@section('title', 'Add NonBinder Book Stock')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Re-Store NonBinder Books</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        @endif
                        <!-- form start -->
                        <form method="post" action="{{ route('stock.nonbinder') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="quantity" value="{{old('quantity')}}" class="form-control" placeholder="বইয়ের কোয়ান্টিটি লিখুন">
                                </div>
                                <div class="form-group">
                                    <label for="price">বইয়ের বিক্রয় মূল্য</label>
                                    <input type="number" name="price" value="{{old('price')}}" class="form-control" placeholder="বইয়ের বিক্রয় মূল্য লিখুন">
                                </div>
                            </div>
                            <!-- /.card-body -->
